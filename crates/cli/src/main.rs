...
enum Cmd {
    ...
    /// サービス(create(+GitHub 連携)/ list / status / rename / subdomain / callers / redeploy-callers / limits /
    /// stateful / start / stop / logs / metrics / stats / deploys / exec / cat / verify / open /
    /// rollback / visibility / delete)
    Service {
        #[command(subcommand)]
